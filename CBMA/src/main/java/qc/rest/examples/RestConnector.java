...
public class RestConnector {
    ...
    public synchronized String buildEntityUrl(String entityType, String entityId) {
    	//For now, we won't have both entityId and query together - both are mutually exclusive
    	if (entityId != null ) {
        return buildUrl("qcbin/rest/domains/"
                        + domain
                        + "/projects/"
    ...
    public synchronized Response httpGet(String url, String queryString, Map<String, String> headers)
            throws Exception {
