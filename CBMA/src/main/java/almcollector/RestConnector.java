...
public class RestConnector {
	 ...
	 * @return
	 */
	public String buildEntityCollectionUrl(String entityType, String field) {
		return buildUrl("qcbin/rest/domains/" + domain + "/projects/" + project + "/" + entityType + "s"+"/groups/"+field);
	}
	...
	public String buildEntityUrl(String entityType, String entityId, String query) {
		// https://alm.corp.cox.com/qcbin/rest/domains/cox/projects/cox/defects?query={user-template-01[Cox_Com];severity[3-Medium];status[Fixed]}
		// For now, we won't have both entityId and query together - both are
		// mutually exclusive
		if (entityId != null) {
			return buildUrl(
		...
		// Setting page size to 1500 by default
			...
			return buildUrl("qcbin/rest/domains/" + domain + "/projects/" + project + "/" + entityType +"?"
	...
	public String buildUrl(String path) {
		return String.format("https://%1$s/%3$s", host, port, path);
	}
